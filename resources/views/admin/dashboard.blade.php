<div class="row"><div class="col-md-12"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.css">
...
var orders = new Chart(ctx_orders, {
    ...
    data: {
        ...
        datasets: [{
            label: '# of Bookings',
            data: [35,110,82,79,57,60,54,44,19,0,0,0],
            backgroundColor: [
                'rgba(54, 162, 235, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(54, 162, 235, 0.2)',
...
var customers = new Chart(ctx_customers, {
    ...
    data: {
        ...
        datasets: [{
            label: '# of Customers',
            data: [37,41,20,23,24,16,16,15,12,19,61,26],
            backgroundColor: [
