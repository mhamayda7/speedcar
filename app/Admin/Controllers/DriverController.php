...
class DriverController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->image('id_proof', __('Id proof'))->move('image/')->uniqueName()->rules('required');
        $form->image('vehicle_image', __('Vehicle Image'))->move('captain_vehicle_image/')->uniqueName()->rules('required');
        $form->image('vehicle_licence', __('Vehicle Licence'))->move('captain_vehicle_licence/')->uniqueName()->rules('required');
